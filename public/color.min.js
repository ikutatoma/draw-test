        ...
        c.namedColors = {}, c.installColorSpace = function (a, i, e) {
          function n(e, r) {
            ...
            for (var t in n[r.toLowerCase()] = function () {
              ...
              }), n) n.hasOwnProperty(t) && void 0 === c[e].prototype[t] && (c[e].prototype[t] = n[t])
          }(c[a] = function (e) {
            var r = Array.isArray(e) ? e : arguments;
            i.forEach(function (e, n) {
              var t = r[n];
              if ("alpha" === e) this._alpha = isNaN(t) || 1 < t ? 1 : t < 0 ? 0 : t;
              else {
        ...
        var n = function (a) {
          ...
          t = function (c) {
            c.installColorSpace("HSV", ["hue", "saturation", "value", "alpha"], {
              ...
              hsl: function () {
                var e, n = (2 - this._saturation) * this._value,
          ...
          r = function (r) {
            r.use(t), r.installColorSpace("HSL", ["hue", "saturation", "lightness", "alpha"], {
              hsv: function () {
                var e, n = 2 * this._lightness,
                  t = this._saturation * (n <= 1 ? n : 2 - n);
                return e = n + t < 1e-9 ? 0 : 2 * t / (n + t), new r.HSV(this._hue, e, (n + t) / 2, this._alpha)
              },
              rgb: function () {
                return this.hsv().rgb()
              },
    ...
    y = function (r) {
      return e = s, (n = [r.init, r.xy, r.z]).map(e).filter(l).length != n.length ? console.warn("colorjoe: missing cb") : function (e, n, t) {
        return function (e) {
          ...
          function c(e) {
            e = _(e) ? e : [];
            for (var n, t = f.change, r = 0, a = t.length; r < a; r++) n = t[r], -1 == e.indexOf(n.name) && n.fn(l)
          }

          function h() {
            if (!s.equals(l)) {
              for (var e = 0, n = f.done.length; e < n; e++) f.done[e].fn(l);
              s = l
            }
          }
          var d = {
          ...
          return function (e, u, n) {
            if (n) {
              ...
              n.forEach(function (e, n) {
                ...
                if (i)
                  for (var o in s = i(c, (r = l + n, (a = function (e) {
                      var n = {};
